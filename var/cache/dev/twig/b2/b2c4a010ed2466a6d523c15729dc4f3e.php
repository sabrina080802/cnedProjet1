...
/* baseadmin.html.twig */
class __TwigTemplate_61564a7dcb6b820e15338960d0b96beb extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_top($context, array $blocks = [])
    {
        ...
        echo "\" alt=\"Image de la bannière\"></a>
        </div>
...
{% block top %}
    <div class=\"container top-header\">
        <!-- titre -->
        <div class=\"text-left logo\">
            <a href=\"{{path('accueil') }}\"><img src=\"{{ app.request.getBasePath()~'/banniere.jpg' }}\" alt=\"Image de la bannière\"></a>
        </div>
        <div class=\"text-end top-title\">
            <h2>Administration</h2>
        </div>
