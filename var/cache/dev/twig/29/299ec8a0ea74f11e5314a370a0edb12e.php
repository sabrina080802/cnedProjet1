...
/* basefront.html.twig */
class __TwigTemplate_58214f9b55dfa8d5884686a67a468d7c extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_top($context, array $blocks = [])
    {
        ...
        // line 6
        echo "    <div class=\"container top-header\">
        <!-- titre -->
        <div class=\"text-left logo\">
            <img src=\"";
        // line 9
        echo twig_escape_filter($this->env, (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 9, $this->source); })()), "request", [], "any", false, false, false, 9), "getBasePath", [], "method", false, false, false, 9) . "/banniere.jpg"), "html", null, true);
        echo "\" >
        </div>
        <!-- menu -->
...
";
    ...
    {
        return array (  202 => 40,  187 => 35,  181 => 31,  171 => 30,  153 => 29,  136 => 22,  130 => 19,  124 => 16,  114 => 9,  109 => 6,  99 => 5,  81 => 4,  63 => 3,  40 => 1,);
    }
...
{% endblock %}
{% block javascripts %}{% endblock %}", "basefront.html.twig", "/Applications/XAMPP/xamppfiles/htdocs/ProjetCned1/mediatekformation/templates/basefront.html.twig");
    }
}
