...
return [
    ...
    'admin.formations.byplaylist' => [[], ['_controller' => 'App\\Controller\\AdminFormationsController::searchByPlaylist'], [], [['text', '/admin/formations/playlist']], [], [], []],
    'admin.playlists' => [[], ['_controller' => 'App\\Controller\\AdminPlaylistsController::index'], [], [['text', '/admin/playlists']], [], [], []],
    'admin.playlists.form' => [[], ['_controller' => 'App\\Controller\\AdminPlaylistsController::edit'], [], [['text', '/admin/playlists/form']], [], [], []],
    'admin.playlists.remove' => [['id'], ['_controller' => 'App\\Controller\\AdminPlaylistsController::remove'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/admin/playlists']], [], [], []],
