...
class getTest_PrivateServicesLocatorService extends App_KernelTestDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        return $container->services['test.private_services_locator'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
            ...
            'App\\Security\\KeycloakAuthenticator' => ['privates', 'App\\Security\\KeycloakAuthenticator', 'getKeycloakAuthenticatorService', true],
            ...
            'session.flash_bag' => ['privates', 'session.flash_bag', 'getSession_FlashBagService', true],
            ...
            'knpu.oauth2.provider_factory' => ['privates', 'knpu.oauth2.provider_factory', 'getKnpu_Oauth2_ProviderFactoryService', true],
            'knpu.oauth2.provider.keycloak' => ['privates', 'knpu.oauth2.provider.keycloak', 'getKnpu_Oauth2_Provider_KeycloakService', true],
            ...
            'Symfony\\Component\\HttpFoundation\\Session\\Flash\\FlashBagInterface' => ['privates', 'session.flash_bag', 'getSession_FlashBagService', true],
            ...
            'KnpU\\OAuth2ClientBundle\\Client\\ClientRegistry' => ['services', 'knpu.oauth2.registry', 'getKnpu_Oauth2_RegistryService', true],
            'KnpU\\OAuth2ClientBundle\\Client\\Provider\\KeycloakClient' => ['services', 'knpu.oauth2.client.keycloak', 'getKnpu_Oauth2_Client_KeycloakService', true],
            'twig.loader.filesystem' => ['privates', 'twig.loader.native_filesystem', 'getTwig_Loader_NativeFilesystemService', false],
            'argument_resolver.controller_locator' => ['privates', '.service_locator.dMff3D3', 'get_ServiceLocator_DMff3D3Service', true],
            ...
            'KnpU\\OAuth2ClientBundle\\Client\\Provider\\KeycloakClient' => '?',
